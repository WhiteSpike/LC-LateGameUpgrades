...
namespace MoreShipUpgrades.Misc
{
    ...
    public class PluginConfig
    {
        ...
        public ConfigEntry<int> BARBED_WIRE_PRICE { get; set; }
        ...
        public ConfigEntry<float> BARBED_WIRE_WEIGHT { get; set; }
        public ConfigEntry<float> BARBED_WIRE_SLOW_MULTIPLIER { get; set; }
        public ConfigEntry<int> BARBED_WIRE_DAMAGE_AMOUNT { get; set; }
        public ConfigEntry<float> BARBED_WIRE_STUN_TIME { get; set; }
        public ConfigEntry<float> BARBED_WIRE_SLOW_PLAYER_MULTIPLIER { get; set; }
        public ConfigEntry<int> BARBED_WIRE_DAMAGE_PLAYER_AMOUNT { get; set; }
        public ConfigEntry<bool> BARBED_WIRE_SLOW_ENEMIES { get; set; }
        public ConfigEntry<bool> BARBED_WIRE_DAMAGE_ENEMIES { get; set; }
        public ConfigEntry<bool> BARBED_WIRE_STUN_ENEMIES { get; set; }
        public ConfigEntry<bool> BARBED_WIRE_SLOW_PLAYERS { get; set; }
        public ConfigEntry<bool> BARBED_WIRE_DAMAGE_PLAYERS { get; set; }
        public ConfigEntry<int> BARBED_WIRE_MAXIMUM_USES { get; set; }
