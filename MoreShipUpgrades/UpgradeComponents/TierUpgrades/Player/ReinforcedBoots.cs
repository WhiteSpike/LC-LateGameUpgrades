...
namespace MoreShipUpgrades.UpgradeComponents.TierUpgrades.Player
{
    internal class ReinforcedBoots : TierUpgrade, IUpgradeWorldBuilding
    {
        ...
        internal const string DEFAULT_PRICES = "250,200,300,400,500";
        ...
        void Awake()
        {
            ...
            overridenUpgradeName = GetConfiguration().ReinforcedBootsConfiguration.OverrideName;
        }
        ...
        public override string GetDisplayInfo(int initialPrice = -1, int maxLevels = -1, int[] incrementalPrices = null)
        {
            ...
            return Tools.GenerateInfoForUpgrade(infoFormat, initialPrice, incrementalPrices, infoFunction, purchaseMode: GetConfiguration().ReinforcedBootsConfiguration.PurchaseMode);
        }
        ...
        public override bool CanInitializeOnStart
        {
            get
            {
                ITierUpgradeConfiguration upgradeConfig = GetConfiguration().ReinforcedBootsConfiguration;
        ...
        {
            return (UPGRADE_NAME, GetConfiguration().ReinforcedBootsConfiguration.ItemProgressionItems.Value.Split(","));
        }
        ...
        {
            return UpgradeBus.Instance.SetupMultiplePurchaseableTerminalNode(UPGRADE_NAME, GetConfiguration().ReinforcedBootsConfiguration);
        }
    }
}
